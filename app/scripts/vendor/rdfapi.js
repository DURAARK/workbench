...
// TK: Adaptions made in order to make RequireJS aware, resolve incompatibles and remove globals.
...
var instanceKeys = function(_this, proto) {
  var keys = [];
  proto = !proto;
  for(var i in _this) {
...
var rdfapi = function() {
  ...
  api.PlainLiteral.prototype = {
    ...
    toNT: function() {
      ...
      return this.language == null ? string : string.concat("@" + this.language)
    }
  };
  /**
   * TypedLiteral
...
Hash.prototype = {
  ...
  keys: function() { return instanceKeys(this.h) },
  remove: function(k) {
    var r = this.get(k);
    delete this.h[k];
    return r
